<template>
  <div class="TemplateManage">
    ...
    <div class="list">
      <el-button type="primary" style="margin-left: 0px;margin-right: 26px;" @click="addTemplate('add')">
    ...
    <!-- 删除动作 -->
    <el-dialog :visible.sync="centerDialogVisible" width="322px" center :show-close="false" top="22vh" class="dia-tem">
