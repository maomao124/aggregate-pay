...
public class AggregatePayLogApplication
{
    ...
    public static void main(String[] args) throws UnknownHostException
    {
        ...
        //启动
        ConfigurableApplicationContext applicationContext = SpringApplication.run(AggregatePayLogApplication.class, args);
        //环境
