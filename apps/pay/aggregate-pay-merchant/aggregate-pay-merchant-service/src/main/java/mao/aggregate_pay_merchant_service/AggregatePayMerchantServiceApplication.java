package mao.aggregate_pay_merchant_service;
...
public class AggregatePayMerchantServiceApplication
{
    ...
    public static void main(String[] args) throws UnknownHostException
    {
        ...
        //启动
        ConfigurableApplicationContext applicationContext = SpringApplication.run(AggregatePayMerchantServiceApplication.class, args);
        //环境
