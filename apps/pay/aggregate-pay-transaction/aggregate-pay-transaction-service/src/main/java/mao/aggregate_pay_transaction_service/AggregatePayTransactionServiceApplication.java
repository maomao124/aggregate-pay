package mao.aggregate_pay_transaction_service;
...
public class AggregatePayTransactionServiceApplication
{
    ...
    (String[] args) throws UnknownHostException
    {
        ...
        //启动
        ConfigurableApplicationContext applicationContext = SpringApplication.run(AggregatePayTransactionServiceApplication.class, args);
        //环境
