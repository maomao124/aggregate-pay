...
public class UAAController extends BaseController
{
    ...
    public void createClientDetails(@RequestBody Map<String, String> map)
    {
    ...
    public Map<String, String> getClientDetailsByClientId(@RequestParam String appId)
    {
        return oauthClientDetailsService.getClientDetailsByClientId(appId);
    }
