 ...
 * Interface(接口名): UAAFeignClientV2
 * Author(作者）: mao
...
@FeignClient(value = "aggregate-pay-uaa-service", path = "/uaa/v2", fallbackFactory = UAAFeignClientV2FallbackFactory.class)
public interface UAAFeignClientV2
{
    ...
    R<Boolean> createClientDetails(@RequestBody Map<String, String> map);
    ...
    R<Map<String, String>> getClientDetailsByClientId(@RequestParam String appId);
