...
import mao.aggregate_pay_user_api.fallback.TenantFeignClientFallbackFactory;
 ...
 * Interface(接口名): TenantFeignClient
 * Author(作者）: mao
...
@FeignClient(value = "aggregate-pay-user-service", path = "/user", fallbackFactory = TenantFeignClientFallbackFactory.class)
public interface TenantFeignClient
{
    ...
    TenantDTO createTenantRelateAccount(@RequestBody CreateTenantRequestDTO createTenantRequest);
    ...
    TenantDTO getTenant(@PathVariable Long id);
    ...
    List<BundleDTO> queryBundleByTenantType(@PathVariable String tenantType);
    ...
    BundleDTO getBundle(@PathVariable String bundleCode);
    ...
    void changeBundle(@PathVariable Long tenantId, @PathVariable String bundleCode);
    ...
    void initBundle(@PathVariable Long tenantId, @PathVariable String bundleCode);
    ...
    @PostMapping("/bundles")
    void createBundle(@RequestBody BundleDTO bundleDTO);
    ...
    @ApiImplicitParam(name = "bundleDTO", value = "套餐信息", required = true, dataType = "BundleDTO", paramType = "body")
    @PutMapping("/bundles")
    void modifyBundle(@RequestBody BundleDTO bundleDTO);
    ...
    AccountDTO createAccount(@RequestBody CreateAccountRequestDTO createAccountRequest);
    ...
    Boolean createAccount(@RequestBody ChangeAccountPwdDTO accountPwdRequest);
    ...
    void createAccountInTenant(@RequestBody CreateAccountRequestDTO createAccountRequest, @PathVariable Long tenantId);
    ...
    void bindTenant(@PathVariable Long tenantId, @PathVariable String username);
    ...
    void unbindTenant(@PathVariable Long tenantId, @PathVariable String username);
    ...
    boolean isExistAccountByUsername(@PathVariable String username);
    ...
    boolean isExistAccountByMobile(@PathVariable String mobile);
    ...
    AccountDTO getAccountByMobile(@PathVariable String mobile);
    ...
    boolean isExistAccountInTenantByUsername(@PathVariable Long tenantId, @PathVariable String username);
    ...
    boolean isExistAccountInTenantByMobile(@PathVariable Long tenantId, @PathVariable String mobile);
    ...
    List<TenantDTO> queryAccountInTenant(@PathVariable String username);
    ...
    String sendMessage(@RequestParam String phone);
    ...
    AccountDTO authentication(@RequestBody AuthenticationInfo authenticationInfo);
    ...
    @PostMapping("/login")
    LoginInfoDTO login(@RequestBody LoginRequestDTO loginRequest);
    ...
    ApplicationDTO getApplicationDTOByClientId(@PathVariable String clientId);
}
