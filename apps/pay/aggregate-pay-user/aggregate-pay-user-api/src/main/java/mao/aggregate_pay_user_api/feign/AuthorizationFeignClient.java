...
import mao.aggregate_pay_user_api.fallback.AuthorizationFeignClientFallbackFactory;
 ...
 * Interface(接口名): AuthorizationFeignClient
 * Author(作者）: mao
...
@FeignClient(value = "aggregate-pay-user-service", path = "/user", fallbackFactory = AuthorizationFeignClientFallbackFactory.class)
public interface AuthorizationFeignClient
{
    ...
    Map<Long, AuthorizationInfoDTO> authorize(@PathVariable String username, @RequestParam Long[] tenantIds);
    ...
    List<PrivilegeDTO> queryPrivilege(@PathVariable Long tenantId, @RequestParam String[] roleCodes);
    ...
    List<PrivilegeDTO> queryPrivilegeByGroupId(@PathVariable Long privilegeGroupId);
    ...
    PrivilegeTreeDTO queryPrivilegeTree(@PathVariable Long tenantId, @RequestParam String[] roleCodes);
    ...
    void createRole(@PathVariable Long tenantId, @RequestBody RoleDTO role);
    ...
    void removeRole(@PathVariable Long tenantId, @PathVariable String roleCode);
    ...
    void modifyRole(@RequestBody RoleDTO role);
    ...
    void roleBindPrivilege(@PathVariable Long tenantId, @PathVariable String roleCode, @RequestParam String[] privilegeCodes);
    ...
    List<RoleDTO> queryRole(@PathVariable Long tenantId);
    ...
    List<RoleDTO> queryRole(@PathVariable Long tenantId, @RequestParam String... roleCodes);
    ...
    RoleDTO queryTenantRole(@PathVariable Long tenantId, @PathVariable String roleCode);
    ...
    void bindAccountRole(@PathVariable String username, @PathVariable Long tenantId, @RequestParam String[] roleCodes);
    ...
    void unbindAccountRole(@PathVariable String username, @PathVariable Long tenantId, @RequestParam String[] roleCodes);
}
