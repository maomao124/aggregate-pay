package mao.aggregate_pay_user_service;
...
public class AggregatePayUserServiceApplication
{
    ...
    public static void main(String[] args) throws UnknownHostException
    {
        ...
        //启动
        ConfigurableApplicationContext applicationContext = SpringApplication.run(AggregatePayUserServiceApplication.class, args);
        //环境
