...
@RestController
@RequestMapping("/v2")
@Api(value = "统一账号-角色权限V2.0", tags = "统一账号-角色权限V2.0")
public class AuthorizationControllerV2 extends BaseController
{
    @Resource
    ...
    public R<Map<Long, AuthorizationInfoDTO>> authorize(@PathVariable String username, @RequestParam Long[] tenantIds)
    {
    ...
    public R<List<PrivilegeDTO>> queryPrivilege(@PathVariable Long tenantId, @RequestParam String[] roleCodes)
    {
        return success(authorizationService.queryPrivilege(tenantId, roleCodes));
    }
    ...
    public R<List<PrivilegeDTO>> queryPrivilegeByGroupId(@PathVariable Long privilegeGroupId)
    {
        return success(authorizationService.queryPrivilegeByGroupId(privilegeGroupId));
    }
    ...
    public R<PrivilegeTreeDTO> queryPrivilegeTree(@PathVariable Long tenantId, @RequestParam String[] roleCodes)
    {
        return success(authorizationService.queryPrivilegeTree(tenantId, roleCodes));
    }
    ...
    public R<Boolean> createRole(@PathVariable Long tenantId, @RequestBody RoleDTO role)
    {
    ...
    public R<Boolean> removeRole(@PathVariable Long tenantId, @PathVariable String roleCode)
    {
    ...
    public R<Boolean> modifyRole(@RequestBody RoleDTO role)
    {
    ...
    public R<Boolean> roleBindPrivilege(@PathVariable Long tenantId, @PathVariable String roleCode, @RequestParam String[] privilegeCodes)
    {
    ...
    public R<List<RoleDTO>> queryRole(@PathVariable Long tenantId)
    {
        return success(authorizationService.queryRole(tenantId));
    }
    ...
    public R<List<RoleDTO>> queryRole(@PathVariable Long tenantId, @RequestParam String... roleCodes)
    {
        return success(authorizationService.queryRole(tenantId, roleCodes));
    }
    ...
    public R<RoleDTO> queryTenantRole(@PathVariable Long tenantId, @PathVariable String roleCode)
    {
        return success(authorizationService.queryTenantRole(tenantId, roleCode));
    }
    ...
    public R<Boolean> bindAccountRole(@PathVariable String username, @PathVariable Long tenantId, @RequestParam String[] roleCodes)
    {
    ...
    public R<Boolean> unbindAccountRole(@PathVariable String username, @PathVariable Long tenantId, @RequestParam String[] roleCodes)
    {
